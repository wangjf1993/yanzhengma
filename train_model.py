...
#
import os
# 解决Your CPU supports instructions that this TensorFlow binary was not compiled
...
class TrainModel(object):
    ...
    def recognize_captcha(self,img_name):

        label, captcha_array = self.gen_captcha_text_image(img_name)
...
def main():
    ...
    for i in range(2, 290):
        ...
        # tm.train_cnn()  # 开始训练模型
        image_name=f'ori{i:03}.jpg'
        print(image_name)
        # image_name='ori003.jpg'
        t=tm.recognize_captcha(image_name)  # 识别图片示例
        item['tupianming']=image_name
        item['tupanchesijieguo']=t
