...
if __name__ == '__main__':
    final_list = verify_istrue(['li.j.qiang@gouuse.cn', 'lijunqiang@gouuse.cn', 'qiangli@gouuse.cn', 'li.q@gouuse.cn', 'lj.qiang@gouuse.cn', 'qiangl@gouuse.cn', 'l.j.qiang@gouuse.cn', 'l_jqiang@gouuse.cn', 'l.junqiang@gouuse.cn', 'lqiang@gouuse.cn', 'l.q@gouuse.cn', 'l_qiang@gouuse.cn', 'l_q@gouuse.cn', 'q.l@gouuse.cn', 'li_q@gouuse.cn', 'l.jqiang@gouuse.cn', 'li_qiang@gouuse.cn', 'li@gouuse.cn', 'lq@gouuse.cn', 'liq@gouuse.cn', 'qiang@gouuse.cn', 'ljqiang@gouuse.cn', 'liqiang@gouuse.cn', 'qiang_li@gouuse.cn', 'q.li@gouuse.cn', 'ql@gouuse.cn', 'li-qiang@gouuse.cn', 'qiang-li@gouuse.cn', 'li-q@gouuse.cn', 'l-qiang@gouuse.cn', 'l-q@gouuse.cn', 'l.qiang@gouuse.cn', 'li.qiang@gouuse.cn', 'qiang.li@gouuse.cn', 'li-jun-qiang@gouuse.cn', 'lj_qiang@gouuse.cn', 'li_j_qiang@gouuse.cn', 'li_jun_qiang@gouuse.cn', 'li-j-qiang@gouuse.cn', 'l_junqiang@gouuse.cn', 'ljunqiang@gouuse.cn', 'lijqiang@gouuse.cn', 'li.jun.qiang@gouuse.cn', 'lj-qiang@gouuse.cn', 'tureisnotture@gouuse.cn '])
    print(final_list)
    # while True:
    #     mylist=[]
    #     test_emaile=input("请输入验证邮箱：")
    #     test_emaile=test_emaile.strip()
    #     T=test_emaile.split('@')
    #     if len(T)==2:
    #         mylist.append(test_emaile)
    #         final_list = verify_istrue(mylist)
    #         print(final_list)
    #     else:
    #         print('请输入正确邮箱！')
